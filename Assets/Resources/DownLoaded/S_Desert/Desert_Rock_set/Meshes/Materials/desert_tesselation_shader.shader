...
Shader "Desert/desert_tesselation_shader" {
    Properties {
        _BumpMap ("Normal Map", 2D) = "bump" {}
        _MainTex ("Base Color", 2D) = "white" {}
        _displacement ("displacement", 2D) = "white" {}
        _displacement_pow ("displacement_pow", Range(0, 1)) = 0.1
        _tesselation_pow ("tesselation_pow", Range(0, 128)) = 1
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            uniform float _displacement_pow;
            uniform float _tesselation_pow;
            struct VertexInput {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    ...
                    v.vertex.xyz += ((_displacement_pow*v.normal)*_displacement_var.rgb);
                }
                float Tessellation(TessVertex v){
                    return _tesselation_pow;
                }
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float roughness = 1.0 - _MainTex_var.a;
